...
import { UID, WidgetTypes } from "@prismicio/types-internal/lib/customtypes/widgets";
import { GroupSM } from "../../models/Group";
import { DynamicSection } from "@prismicio/types-internal/lib/customtypes/Section";
export declare const TabFields: t.ArrayC<t.TypeC<{
    key: t.StringC;
    value: t.UnionC<[t.UnionC<[t.ExactC<t.IntersectionC<[t.TypeC<{
...
export declare type TabFields = t.TypeOf<typeof TabFields>;
export declare const TabSM: t.IntersectionC<[t.TypeC<{
    key: t.StringC;
...
export declare type TabSM = t.TypeOf<typeof TabSM>;
export declare const Tabs: {
    toSM(key: string, tab: DynamicSection): TabSM;
    fromSM(tab: TabSM): DynamicSection;
};
export declare type TabField = NestableWidget | UID | GroupSM;
